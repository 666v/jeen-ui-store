...
const translations = {
  ...
  ar: {
    ...
    // Hero section
    hero_badgeNew: 'جديد',
    hero_badgeAnnouncement: 'أطلقنا دفعة قوالب جديدة',
    hero_headline1: 'وجهتك الأولى',
    hero_headline2: 'لشراء',
    hero_headlineHighlight: 'قوالب مواقع مميزة',
    hero_subheading: 'اكتشف تشكيلة حصرية من قوالب المواقع المميزة مصممة خصيصًا للأعمال، الشركات الناشئة والمتاجر الإلكترونية. خلي حضورك أونلاين يلفت الأنظار بتصاميم جاهزة للاستخدام على طول',
    hero_ctaPrimary: 'ابدأ الحين',
    hero_ctaSecondary: 'شوف المزيد',
    hero_activeUsers: 'مستخدم نشط',
    hero_satisfaction: 'رضا العملاء',
